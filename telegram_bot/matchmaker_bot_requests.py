...
class MatchmakerBot:
    ...
    Uses requests library instead of google-genai to avoid httpx encoding issues.
    """
...
"""
    ...
    def _build_conversation_contents(self, user_message: str) -> List[Dict]:
        """
        ...
        Returns:
            List[Dict]: List of content objects for the API
        """
        contents = []
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if "candidates" in result and len(result["candidates"]) > 0:
                        ...
                        # 确保响应文本是安全的UTF-8字符串
                        response_text = safe_encode_string(response_text)
